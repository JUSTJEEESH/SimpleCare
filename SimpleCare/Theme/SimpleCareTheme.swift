...
enum SimpleCareColors {
    ...
    static let sageLight = Color(red: 0.85, green: 0.91, blue: 0.86)
    static let sageDark = Color(red: 0.38, green: 0.50, blue: 0.40)

    static let calmBlue = Color(red: 0.45, green: 0.62, blue: 0.78)
    static let calmBlueLight = Color(red: 0.82, green: 0.89, blue: 0.96)
    static let calmBlueDark = Color(red: 0.28, green: 0.45, blue: 0.62)

    static let charcoal = Color(red: 0.25, green: 0.27, blue: 0.29)
    static let charcoalLight = Color(red: 0.42, green: 0.44, blue: 0.46)

    // Semantic colors
    static let warmBackground = Color(red: 0.97, green: 0.96, blue: 0.94)
    static let cardBackground = Color.white
    static let secondaryText = Color(red: 0.55, green: 0.55, blue: 0.55)
    ...
    static let upcoming = Color(red: 0.70, green: 0.70, blue: 0.70)
